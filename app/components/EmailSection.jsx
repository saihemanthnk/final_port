...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid grid-cols-2 my-6 md:my-8 py-12 gap-8 relative scroll-mt-10"
    >
      ...
      <div>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div className="mb-3">
            <label
              htmlFor="email"
              className="text-white font-medium mb-1 text-sm block"
            >
              Your Email?
            </label>
            <input
              className="bg-[#18191E] border border-[#33353F] py-2 px-3 rounded-md text-gray-100 text-sm placeholder-[#9CA2A9] block w-full"
              type="email"
              id="email"
              name="email"
              required
          ...
          <div className="mb-3">
            <label
              htmlFor="subject"
              className="text-white mb-1 font-medium text-sm block"
            >
              Subject
            </label>
            <input
          ...
          <button
            type="submit"
            className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-4 rounded-full w-full"
          >
            Send Message
          </button>
